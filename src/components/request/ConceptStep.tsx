    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          className="min-h-[200px] bg-ink-dark border-ink-border text-white placeholder:text-ink-muted resize-none"
        />
      ...
      <div className="space-y-2">
        <Label htmlFor="meaning" className="text-white text-base">
          Personal Meaning <span className="text-ink-muted text-sm">(Optional)</span>
        </Label>
        <Textarea
          id="meaning"
          ...
          className="min-h-[100px] bg-ink-dark border-ink-border text-white placeholder:text-ink-muted resize-none"
        />
        <p className="text-sm text-ink-muted">
