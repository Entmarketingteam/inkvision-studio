  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-ink-muted">Upload images or add notes about visual references</p>
      </div>

      <div>
        <Label className="text-white text-base mb-4 block">
          Reference Images <span className="text-ink-muted text-sm">(Optional)</span>
        </Label>
        <div className="border-2 border-dashed border-ink-border rounded-lg p-8 text-center hover:border-ink-muted transition-colors">
          <Upload className="h-12 w-12 text-ink-muted mx-auto mb-4" />
          <p className="text-white mb-2">Drag & drop images here</p>
          <p className="text-ink-muted text-sm mb-4">or click to browse (max 5 images)</p>
      ...
      <div className="space-y-2">
        <Label htmlFor="reference_notes" className="text-white text-base">
          Reference Notes <span className="text-ink-muted text-sm">(Optional)</span>
        </Label>
        <Textarea
          id="reference_notes"
          ...
          className="min-h-[120px] bg-ink-dark border-ink-border text-white placeholder:text-ink-muted resize-none"
        />
      </div>
    </div>
  );
